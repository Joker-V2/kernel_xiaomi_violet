...
#include <linux/msm_drm_notify.h>   /* modify by zhangchaofan@longcheer.com for kernel 4.9, 2018-12-25 */
...
struct fts_ts_data {
    ...
    struct work_struct interr_work;
	...
	uint8_t touch_state;    /* modify by zhangchaofan@longcheer.com Touch state, 2019-01-14 */
    int irq;
    bool suspended;
    bool fw_loading;
    bool irq_disabled;
